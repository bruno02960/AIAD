...
public class DetectEnoughFuelQuantity extends TickerBehaviour {
	 ...
	 * @param period
	 */
	public DetectEnoughFuelQuantity(AircraftAgent aircraftAgent, long period) {
	...
	protected void onTick() {
		...
		if(aircraftAgent.getFuelTankQuantity() < (Config.AIRCRAFT_MAX_FINAL_FUEL_TANK_CAPACITY / 2) && !this.aircraftAgent.isBusy() )
			this.aircraftAgent.goRefillFuelTank();
	}
}